...
class HDF5File:
    ...
    def __init__(self, filename, filedir='.', mode='w'):
        """
        Class for working with HDF5 files. Can be used to create new files and
        save data.
    ...
    def save_dataset(self, dsetname, dsetmetadata, dsetdata, t0=None):
        with h5py.File(name=self.file, mode='a') as f:
...
if __name__ == '__main__':
    ...
    h5file.save_dataset(dsetname='movement-top-1', dsetmetadata=metadata, dsetdata=[[1,2,3],[4,5,6]],t0=time.time())
